...
export default function ResourcesIndexPage() {
  const items = getAllCocktailResources().filter(
    (r) => !(r.tags || []).some((t) => String(t).toLowerCase() === "best bars"),
  );
    ...
    >
      ...
      >
        <div style={{ maxWidth: maxContent, margin: "0 auto" }}>
          ...
          >
            Ratios, ice, citrus, tonic, and tools — the fundamentals that change how drinks taste.
          </p>
        </div>
      </section>
